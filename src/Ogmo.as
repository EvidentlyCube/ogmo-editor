package {
    ...
    import editor.commons.Project;
    import editor.commons.Settings;
    import editor.ui.*;
    import editor.ui.menubar.MenuBar;
    import editor.ui.windows.DebugWindow;
    import editor.ui.windows.MainMenuWindow;
    import editor.ui.windows.MessageWindow;
    ...
    public class Ogmo extends Sprite {
         ...
         */
        static public var windowMenu:MenuBar;
        /**
         ...
         */
        static public var message:MessageWindow;
        /**
        ...
        static public var currentLevelPath:String;
        ...
        static public function openProjectDirectory():void {
            try {
                Object(project.workingDirectory).openWithDefaultApplication();
            }
            catch (e:Error) {
        ...
        static public function showMessage(text:String, time:int = 2000, large:Boolean = false):void {
            ...
            message = new MessageWindow(text, time, large);
        ...
        public function initMainMenu():void {
            addChild(new MainMenuWindow);
        }

        public function destroyMainMenu():void {
            for (var i:int = 0; i < numChildren; i++) {
                if (getChildAt(i) is MainMenuWindow) {
                    removeChildAt(i);
                    i--;
                }
            }
        ...
        public function saveLevel():void {
            if (!currentLevelPath) {
                ...
                tempFile = new File(currentLevelPath);
        ...
        public function loadLevel(file:File):void {
            tempFile = file;
            onLoadLevelSelect();
            currentLevelPath = file.nativePath;
        }
        ...
        private function onSaveLevelSelect(e:Event):void {
            ...
            currentLevelPath = tempFile.nativePath;
            tempFile = null;
