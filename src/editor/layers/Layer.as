package editor.layers
{
    ...
    public class Layer extends Sprite
    {
        ...
        private var _renderTransparent:Boolean = true;
        ...
        public function get renderTransparent():Boolean {
            return _renderTransparent;
        }

        public function set renderTransparent(value:Boolean):void {
            _renderTransparent = value;
            if (!active){
