package editor.layers.object
{
    ...
    public class Node extends Sprite
    {
        ...
        {
            x = Math.max( Math.min( x + h, Ogmo.level.levelWidth - Ogmo.level.selectedLayer.gridSize ), 0 );
            y = Math.max( Math.min( y + v, Ogmo.level.levelHeight - Ogmo.level.selectedLayer.gridSize ), 0 );
        }
