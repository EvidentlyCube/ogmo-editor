    ...
    public class ToolGridRectangle extends GridTool
    {
        ...
        private function onMouseUp(e:MouseEvent):void
        {
            if (placing)
            {
                ...
                gridLayer.grid.setCellsRectangle(Ogmo.rect.x / gridLayer.gridSize, Ogmo.rect.y / gridLayer.gridSize, Ogmo.rect.width / gridLayer.gridSize, Ogmo.rect.height / gridLayer.gridSize, drawMode);
        ...
        private function onKeyDown(e:KeyboardEvent):void
        {
            if (e.keyCode == Ogmo.keycode_ctrl)
                layer.setTool(
                    new ToolGridFill(layer), 
                    new QuickTool(ToolGridRectangle, QuickTool.CTRL)
                );
        }
