package editor.ui.windows
{
    ...
    public class TilePaletteWindow extends Sprite
    {
        ...
        public function TilePaletteWindow(tileset:Tileset)
        {
        ...
        {
            selbox.x = Ogmo.level.selectedTilePoint.x * tileset.paletteScale;
            selbox.y = Ogmo.level.selectedTilePoint.y * tileset.paletteScale;
        }
        ...
        {
            if (Ogmo.missKeys || !Ogmo.windows.windowTilesetPalette.active || e.ctrlKey)
                return;
        ...
        {
            var ax:int = Ogmo.level.selectedTilePoint.x + x * tileset.tileWidth;
            var ay:int = Ogmo.level.selectedTilePoint.y + y * tileset.tileHeight;
        ...
        {
            Ogmo.level.selectedTilePoint.x = x;
            Ogmo.level.selectedTilePoint.y = y;

            positionSelbox();
            stage.dispatchEvent(new TileSelectEvent(Ogmo.level.selectedTilePoint));
        }
