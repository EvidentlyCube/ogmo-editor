package editor.ui.valueModifiers {
    ...
    public dynamic class ValueModifierSlider extends ValueModifier {
        ...
        public function ValueModifierSlider(x:int, y:int, def:Number, min:Number, max:Number, length:int, onlyInt:Boolean = false, callback:Function = null) {
            super(callback);
