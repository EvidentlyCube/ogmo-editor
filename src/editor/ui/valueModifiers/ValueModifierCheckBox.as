package editor.ui.valueModifiers
{
    ...
    public dynamic class ValueModifierCheckBox extends ValueModifier
    {
        ...
        public function ValueModifierCheckBox( x:int, y:int, def:Boolean = false, callback:Function = null )
        {
            super(callback);
